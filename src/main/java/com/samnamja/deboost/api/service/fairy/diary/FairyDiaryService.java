...
public class FairyDiaryService {
    ...
    public ChatCompletionDto getFairyContent(DiaryMakeRequestDto diaryMakeRequestDto) {
        ...
        messageList.add(MessageRequestDto.builder().role("assistant").content("저는 위 답변들을 듣고 아이들이 좋아할 만한 행복한 결말의 동화를 창작하는 동화작가입니다. 아이들이 좋아할 만한 전래동화같은 행복한 결말의 동화를 작성해드리겠습니다.총 4개의 문단으로 구성되어 있으며 각 문단은 4개의 문장으로 이뤄져있습니다.").build());
